...
namespace QueryBase
{
    public interface IQueryRepoBase
    {
        ...
        Task<TDto?> ReadById<TEntity, TDto, TKey>(TKey id) where TEntity : class, IQueryKey<TKey> where TDto : class;
        ...
        /// <returns></returns>
        Task<IEnumerable<TDto>> ReadFilteredPaginate<TEntity, TDto, TFilter>(QueryPaginationFilter<TFilter> paginationFilter, Expression<Func<TDto, bool>>? or = null, Expression<Func<TDto, bool>>? and = null) where TEntity : class where TDto : class where TFilter : class;
        /// <summary>
        ...
        /// <returns></returns>
        Task<TEntity> Update<TEntity, TRequest, TKey>(TRequest request, bool save = true, Expression<Func<IQueryable<TEntity>, IQueryable<TEntity>>>? includes = null) where TEntity : class, IQueryKey<TKey> where TRequest : class, IQueryKey<TKey>;
        ...
        Task SoftDelete<TEntity>(TEntity entity, bool save) where TEntity : class, IQueryStatus;
        Task SoftDelete<TEntity, TKey>(TKey id, bool save = true) where TEntity : class, IQueryEntity<TKey>;
        /// <summary>
        ...
        /// </remarks>
        /// <returns></returns>
        Task BulkSoftDelete<TEntity>(Expression<Func<TEntity, bool>> predicate) where TEntity : class, IQueryStatus;
    }
}
